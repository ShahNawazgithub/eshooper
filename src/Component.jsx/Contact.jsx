                ...
                <div className="container">
                    <div className="row no-gutters slider-text align-items-center justify-content-center">
                        <div className="col-md-9 ftco-animate text-center">
                            <p className="breadcrumbs"><span className="mr-2"><Link to="#"></Link></span> <span>Contact</span></p>
                ...
                <div className="container">
                    <div className="row d-flex mb-5 contact-info">
                        ...
                        <div className="col-md-3 d-flex">
                            <div className="info bg-white p-4">
                                <p><span>Address:</span> G-12/178,Ratiya Marg, Sangham Vihar, South Delhi,Delhi 110080 </p>
                            </div>
                        </div>
                        <div className="col-md-3 d-flex">
                            <div className="info bg-white p-4">
                                <p><span>Phone:</span> <Link to="tel://1234567920">+91 7014737271</Link></p>
                            </div>
                        </div>
                        <div className="col-md-3 d-flex">
                            <div className="info bg-white p-4">
                                <p><span>Email:</span> <Link to="mailto:info@yoursite.com">ashahnawaz456@gmail.com</Link></p>
                            </div>
                        </div>
                        <div className="col-md-3 d-flex">
                            <div className="info bg-white p-4">
                                <p><span>Website</span> <Link to="#">www.sikhrahna.com</Link></p>
                            </div>
                        </div>
                    </div>
                    <div className="row block-9">
                        ...
                        <div className="col-md-6 d-flex">
                            ...
                            <div className="mapouter"><div className="gmap_canvas"><iframe width="565" height="650" id="gmap_canvas" src="https://maps.google.com/maps?q=GNDEC&t=&z=13&ie=UTF8&iwloc=&output=embed" frameBorder="0" scrolling="no" marginHeight="0" marginWidth="0"></iframe></div></div>
                        </div>
                    </div>
                </div>
            </section>
